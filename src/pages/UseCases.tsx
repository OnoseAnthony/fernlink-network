const useCases = [
  ...
  },
  {
    ...
    desc: "Bring Solana to regions with unreliable internet. Fernlink enables transaction verification via local BLE and WiFi meshes, routing requests through peers until one with connectivity can reach the RPC.",
    benefits: ["Offline-capable verification", "Low bandwidth usage", "Works with modern Android and iOS"],
  },
  {
    icon: "point_of_sale",
    code: "UC_003",
    title: "Physical Commerce",
    desc: "NFC tap-to-pair accelerates BLE discovery at merchant terminals from several seconds to under 200ms. Once paired, the BLE mesh handles all proof traffic — no round-trip to a remote server required.",
    benefits: ["Sub-200ms peer pairing via NFC", "Works in poor connectivity", "Seamless POS integration"],
  },
  {
    icon: "shield",
    code: "UC_004",
    title: "Network Resilience",
    desc: "When RPC providers experience outages, Fernlink meshes keep verification flowing. A 64-request store-and-forward queue preserves pending requests and drains automatically when connectivity is restored.",
    benefits: ["Outage protection", "Store-and-forward queuing", "No single point of failure"],
  },
  {
    icon: "trending_up",
    code: "UC_005",
