...
export const FERNLINK_SERVICE_UUID        = "fe4e000000001000800000805f9b34fb";

/** Write-only — originator sends a VerificationRequest here */
export const CHARACTERISTIC_REQUEST_UUID  = "fe4e000100001000800000805f9b34fb";

/** Notify — verifier emits signed VerificationProofs here */
export const CHARACTERISTIC_PROOF_UUID    = "fe4e000200001000800000805f9b34fb";

/** Read — peer advertises capabilities (protocol version, commitment support) */
export const CHARACTERISTIC_STATUS_UUID   = "fe4e000300001000800000805f9b34fb";
